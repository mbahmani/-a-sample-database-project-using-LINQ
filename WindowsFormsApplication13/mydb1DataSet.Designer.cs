...
namespace WindowsFormsApplication13 {
    ...
    public partial class mydb1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Table1Row AddTable1Row(int row, string name, string family) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public Table1Row FindByrow(int row) {
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public int row {
                get {
                    return ((int)(this[this.tableTable1.rowColumn]));
                }
                set {
                    this[this.tableTable1.rowColumn] = value;
                }
            }
...
namespace WindowsFormsApplication13.mydb1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table1] WHERE (([row] = @Original_row) AND ((@IsNull_name = 1 " +
                "AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_family = 1 AND [" +
                "family] IS NULL) OR ([family] = @Original_family)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table1] ([row], [name], [family]) VALUES (@row, @name, @family" +
                ");\r\nSELECT row, name, family FROM Table1 WHERE (row = @row)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table1] SET [row] = @row, [name] = @name, [family] = @family WHERE (([row] = @Original_row) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_family = 1 AND [family] IS NULL) OR ([family] = @Original_family)));
SELECT row, name, family FROM Table1 WHERE (row = @row)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication13.Properties.Settings.Default.mydb1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT row, name, family FROM dbo.Table1";
        ...
        public virtual int Fill(mydb1DataSet.Table1DataTable dataTable) {
        ...
        public virtual mydb1DataSet.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            mydb1DataSet.Table1DataTable dataTable = new mydb1DataSet.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(mydb1DataSet.Table1DataTable dataTable) {
        ...
        public virtual int Delete(int Original_row, string Original_name, string Original_family) {
        ...
        public virtual int Insert(int row, string name, string family) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(row));
            if ((name == null)) {
        ...
        public virtual int Update(int row, string name, string family, int Original_row, string Original_name, string Original_family) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(row));
            if ((name == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_row));
            if ((Original_name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string family, int Original_row, string Original_name, string Original_family) {
            return this.Update(Original_row, name, family, Original_row, Original_name, Original_family);
        }
    }
